...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 26 2018 г., 13:33
...
--
-- Структура таблицы `wp_circle_image_carousel`
--
...
--
-- Дамп данных таблицы `wp_circle_image_carousel`
--
...
--
-- Структура таблицы `wp_huge_itportfolio_images`
--
...
--
-- Дамп данных таблицы `wp_huge_itportfolio_images`
--
...
--
-- Структура таблицы `wp_huge_itportfolio_portfolios`
--
...
--
-- Дамп данных таблицы `wp_huge_itportfolio_portfolios`
--
...
--
-- Структура таблицы `wp_huge_it_videogallery_galleries`
--
...
--
-- Дамп данных таблицы `wp_huge_it_videogallery_galleries`
--
...
--
-- Структура таблицы `wp_huge_it_videogallery_videos`
--
...
--
-- Дамп данных таблицы `wp_huge_it_videogallery_videos`
--
...
(110, 'cron', 'a:5:{i:1519679029;a:1:{s:16:"wp_version_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1519679030;a:2:{s:17:"wp_update_plugins";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_update_themes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1519722252;a:2:{s:19:"wp_scheduled_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}s:25:"delete_expired_transients";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}i:1519727476;a:1:{s:30:"wp_scheduled_auto_draft_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}s:7:"version";i:2;}', 'yes'),
...
(132, '_site_transient_update_themes', 'O:8:"stdClass":4:{s:12:"last_checked";i:1519639630;s:7:"checked";a:4:{s:7:"liberty";s:3:"1.0";s:13:"twentyfifteen";s:3:"1.9";s:15:"twentyseventeen";s:3:"1.4";s:13:"twentysixteen";s:3:"1.4";}s:8:"response";a:0:{}s:12:"translations";a:0:{}}', 'no'),
...
--
-- Структура таблицы `wp_responsive_video_grid`
--
...
--
-- Дамп данных таблицы `wp_responsive_video_grid`
--
...
--
-- Структура таблицы `wp_rich_web_photo_slider_instal`
--
...
--
-- Дамп данных таблицы `wp_rich_web_photo_slider_instal`
--
...
--
-- Структура таблицы `wp_rich_web_photo_slider_manager`
--
...
--
-- Дамп данных таблицы `wp_rich_web_photo_slider_manager`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect1`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect1`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect1_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect1_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect2`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect2`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect2_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect2_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect3`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect3`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect3_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect3_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect4`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect4`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect4_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect4_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect5`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect5`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect5_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect5_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect6`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect6`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect6_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect6_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect7`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect7`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect7_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect7_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect8`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect8`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect8_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect8_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect9`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect9`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect9_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect9_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect10`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect10`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effect10_loader`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effect10_loader`
--
...
--
-- Структура таблицы `wp_rich_web_slider_effects_data`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_effects_data`
--
...
--
-- Структура таблицы `wp_rich_web_slider_font_family`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_font_family`
--
...
--
-- Структура таблицы `wp_rich_web_slider_id`
--
...
--
-- Дамп данных таблицы `wp_rich_web_slider_id`
--
...
(30, 1, 'session_tokens', 'a:1:{s:64:"68487745ff37d7a7dad220ab620ff524d4084cb08292179cdde4c37763631ad3";a:4:{s:10:"expiration";i:1519558237;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:114:"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.167 Safari/537.36";s:5:"login";i:1519385437;}}');
...
--
-- Индексы таблицы `wp_circle_image_carousel`
--
...
--
-- Индексы таблицы `wp_huge_itportfolio_images`
--
ALTER TABLE `wp_huge_itportfolio_images`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_huge_itportfolio_portfolios`
--
ALTER TABLE `wp_huge_itportfolio_portfolios`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_huge_it_videogallery_galleries`
--
ALTER TABLE `wp_huge_it_videogallery_galleries`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id` (`id`);

--
-- Индексы таблицы `wp_huge_it_videogallery_videos`
--
...
--
-- Индексы таблицы `wp_responsive_video_grid`
--
ALTER TABLE `wp_responsive_video_grid`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_photo_slider_instal`
--
ALTER TABLE `wp_rich_web_photo_slider_instal`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_photo_slider_manager`
--
ALTER TABLE `wp_rich_web_photo_slider_manager`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect1`
--
ALTER TABLE `wp_rich_web_slider_effect1`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect1_loader`
--
ALTER TABLE `wp_rich_web_slider_effect1_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect2`
--
ALTER TABLE `wp_rich_web_slider_effect2`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect2_loader`
--
ALTER TABLE `wp_rich_web_slider_effect2_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect3`
--
ALTER TABLE `wp_rich_web_slider_effect3`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect3_loader`
--
ALTER TABLE `wp_rich_web_slider_effect3_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect4`
--
ALTER TABLE `wp_rich_web_slider_effect4`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect4_loader`
--
ALTER TABLE `wp_rich_web_slider_effect4_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect5`
--
ALTER TABLE `wp_rich_web_slider_effect5`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect5_loader`
--
ALTER TABLE `wp_rich_web_slider_effect5_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect6`
--
ALTER TABLE `wp_rich_web_slider_effect6`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect6_loader`
--
ALTER TABLE `wp_rich_web_slider_effect6_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect7`
--
ALTER TABLE `wp_rich_web_slider_effect7`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect7_loader`
--
ALTER TABLE `wp_rich_web_slider_effect7_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect8`
--
ALTER TABLE `wp_rich_web_slider_effect8`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect8_loader`
--
ALTER TABLE `wp_rich_web_slider_effect8_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect9`
--
ALTER TABLE `wp_rich_web_slider_effect9`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect9_loader`
--
ALTER TABLE `wp_rich_web_slider_effect9_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect10`
--
ALTER TABLE `wp_rich_web_slider_effect10`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effect10_loader`
--
ALTER TABLE `wp_rich_web_slider_effect10_loader`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_effects_data`
--
ALTER TABLE `wp_rich_web_slider_effects_data`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_font_family`
--
ALTER TABLE `wp_rich_web_slider_font_family`
 ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `wp_rich_web_slider_id`
--
...
--
-- AUTO_INCREMENT для таблицы `wp_circle_image_carousel`
--
ALTER TABLE `wp_circle_image_carousel`
...
--
-- AUTO_INCREMENT для таблицы `wp_huge_itportfolio_images`
--
ALTER TABLE `wp_huge_itportfolio_images`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT для таблицы `wp_huge_itportfolio_portfolios`
--
ALTER TABLE `wp_huge_itportfolio_portfolios`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `wp_huge_it_videogallery_galleries`
--
ALTER TABLE `wp_huge_it_videogallery_galleries`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_huge_it_videogallery_videos`
--
ALTER TABLE `wp_huge_it_videogallery_videos`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `wp_options`
MODIFY `option_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=776;
--
-- AUTO_INCREMENT для таблицы `wp_postmeta`
--
ALTER TABLE `wp_postmeta`
MODIFY `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=333;
--
...
--
-- AUTO_INCREMENT для таблицы `wp_responsive_video_grid`
--
ALTER TABLE `wp_responsive_video_grid`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_photo_slider_instal`
--
ALTER TABLE `wp_rich_web_photo_slider_instal`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_photo_slider_manager`
--
ALTER TABLE `wp_rich_web_photo_slider_manager`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect1`
--
ALTER TABLE `wp_rich_web_slider_effect1`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect1_loader`
--
ALTER TABLE `wp_rich_web_slider_effect1_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect2`
--
ALTER TABLE `wp_rich_web_slider_effect2`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect2_loader`
--
ALTER TABLE `wp_rich_web_slider_effect2_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect3`
--
ALTER TABLE `wp_rich_web_slider_effect3`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect3_loader`
--
ALTER TABLE `wp_rich_web_slider_effect3_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect4`
--
ALTER TABLE `wp_rich_web_slider_effect4`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect4_loader`
--
ALTER TABLE `wp_rich_web_slider_effect4_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect5`
--
ALTER TABLE `wp_rich_web_slider_effect5`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect5_loader`
--
ALTER TABLE `wp_rich_web_slider_effect5_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect6`
--
ALTER TABLE `wp_rich_web_slider_effect6`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect6_loader`
--
ALTER TABLE `wp_rich_web_slider_effect6_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect7`
--
ALTER TABLE `wp_rich_web_slider_effect7`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect7_loader`
--
ALTER TABLE `wp_rich_web_slider_effect7_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect8`
--
ALTER TABLE `wp_rich_web_slider_effect8`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect8_loader`
--
ALTER TABLE `wp_rich_web_slider_effect8_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect9`
--
ALTER TABLE `wp_rich_web_slider_effect9`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect9_loader`
--
ALTER TABLE `wp_rich_web_slider_effect9_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect10`
--
ALTER TABLE `wp_rich_web_slider_effect10`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effect10_loader`
--
ALTER TABLE `wp_rich_web_slider_effect10_loader`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_effects_data`
--
ALTER TABLE `wp_rich_web_slider_effects_data`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_font_family`
--
ALTER TABLE `wp_rich_web_slider_font_family`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=126;
--
-- AUTO_INCREMENT для таблицы `wp_rich_web_slider_id`
--
ALTER TABLE `wp_rich_web_slider_id`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
