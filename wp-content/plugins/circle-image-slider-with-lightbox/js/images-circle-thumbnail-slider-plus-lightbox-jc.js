...
;(function($) {
  ...
  $.fn.bxSlider_ = function(options) {
    ...
    var setup = function() {
      ...
      el.wrap('<div class="' + slider.settings.wrapperClass + '"><div class="bx-viewport_"></div></div>');
