<?php
    ...
    Plugin URI:http://www.i13websolution.com/wordpress-circle-image-gallery-slider-with-lightbox-pro.html
    Author URI:http://www.i13websolution.com/wordpress-circle-image-gallery-slider-with-lightbox-pro.html
    ...
    */
    ...
    <div style="clear: both;"></div>
                            ...
                            <div style="postion:relative;margin: 0px auto;visibility: hidden;margin-left: 7.5%;margin-right: 5%;" id="divResponsiveSliderPlusLightboxMain_admin">
                                        ...
                                        if(count($rows) > 0){
                                            foreach($rows as $row){
                                                ...
                                                if(trim($row['title'])!='' and trim($row['custom_link'])!=''){
                                                    ...
                                                    $Caption="<div class='mycaption_title'><a class='Captionlink' href='{$row['custom_link']}'>{$rowTitle}</a></div>";
                                                    $title="<a target='_blank' class='Imglink'  href='{$row['custom_link']}'>{$rowTitle}</a>";
                                            ...
                                            <div class="limargin">
                                                <a target='_blank' style="cursor: default"  rel="<?php echo $randOmeAlbName;?>" data-overlay="1" data-title="<?php echo $title;?>" class="r_lbox" <?php if($settings['lightbox']):?> href="<?php echo $outputimgmain;?>" <?php elseif($row['custom_link']!='' ):?> href="<?php echo $row['custom_link'];?>" <?php else: ?> <?php endif;?>>
                                                    <div class="circle-img" >
                                                        <img <?php if($settings['lightbox']):?> onclick="return clickedItem(uniqObj);" <?php endif;?> src="<?php echo $outputimg; ?>" alt="<?php echo $rowTitle; ?>" title="<?php if(trim($rowTitle)!=''){ echo $rowTitle;}  ?>"  />
                                                    </div>
                                                </a> 
